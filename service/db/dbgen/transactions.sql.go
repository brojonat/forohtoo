...
RETURNING signature, wallet_address, slot, block_time, amount, token_mint, memo, confirmation_status, created_at
`
...
SELECT signature, wallet_address, slot, block_time, amount, token_mint, memo, confirmation_status, created_at FROM transactions
WHERE wallet_address = $1
